...
const INDUSTRIES = [
  'Accounting & Tax Services', 'Advertising & Marketing', 'Aerospace & Defense', 'Agriculture',
  'AI & Machine Learning', 'Architecture & Design', 'Arts & Crafts', 'Automotive',
  'Aviation & Aerospace', 'Beauty & Cosmetics', 'Biotechnology', 'Blockchain & Web3',
  'Cannabis & Hemp', 'Childcare & Early Education', 'Cleaning Services', 'Construction',
  'Consulting', 'Coworking & Shared Spaces', 'Cybersecurity', 'Data Analytics',
  'Dental & Orthodontics', 'E-Commerce', 'Education & EdTech', 'Elder Care & Senior Living',
  'Electronics & Hardware', 'Energy & Utilities', 'Entertainment & Media', 'Environmental Services',
  'Event Planning & Management', 'Fashion & Apparel', 'Film & Television', 'Finance & Banking',
  'FinTech', 'Fitness & Wellness', 'Food & Beverage', 'Franchising',
  'Furniture & Home Decor', 'Gaming', 'Government & Public Sector', 'Graphic Design',
  'Healthcare & Medical', 'Home Services & Maintenance', 'Hospitality & Tourism', 'Human Resources & Recruiting',
  'Import & Export', 'Information Technology', 'Insurance', 'Interior Design',
  'IoT & Smart Devices', 'Jewelry & Accessories', 'Journalism & Publishing', 'Legal Services',
  'Logistics & Supply Chain', 'Luxury Goods', 'Manufacturing', 'Marine & Boating',
  'Mental Health & Therapy', 'Mining & Resources', 'Mobile Apps', 'Music & Audio',
  'Nanotechnology', 'Non-Profit & NGO', 'Nutrition & Dietetics', 'Oil & Gas',
  'Optometry & Eye Care', 'Organic & Natural Products', 'Packaging & Printing', 'Pets & Animals',
  'Pharmaceuticals', 'Photography & Videography', 'Podcasting & Streaming', 'Public Relations',
  'Real Estate', 'Religious & Faith-Based', 'Renewable Energy', 'Restaurants & Food Service',
  'Retail', 'Robotics & Automation', 'SaaS & Software', 'Security Services',
  'Social Media & Influencer', 'Space Technology', 'Sports', 'Staffing & Temp Agencies',
  'Sustainability & CleanTech', 'Telecommunications', 'Textiles & Fabrics', 'Translation & Localization',
  'Transportation', 'Travel & Aviation', 'Venture Capital & Startups', 'Veterinary Services',
  'Virtual Reality & AR', 'Warehousing & Distribution', 'Waste Management & Recycling', 'Wedding & Bridal',
];
